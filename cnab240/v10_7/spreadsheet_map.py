...
CUSTOM_FIELDS_MAPPING = {
    ...
    "lote_header": {
        ...
        "field_05_1": {"name": "Tipo do Serviço", "lambda": "get_tipo_de_servico"},
        "field_06_1": {
    ...
    "lote_detalhe_segmento_a": {
        ...
        "field_06_3A": {"name": "Tipo de Movimento", "lambda": "get_tipo_de_movimento"},
        "field_07_3A": {
        ...
        "field_18_3A": {"name": "Tipo da Moeda", "lambda": "get_tipo_de_moeda"},
    ...
    "lote_detalhe_segmento_b": {
        ...
        "field_06_3B": {"name": "Forma de Iniciação", "lambda": "get_forma_iniciacao"},
        "field_07_3B": {
