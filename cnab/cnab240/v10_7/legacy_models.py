...
class CNAB240File:
    ...
    def __init__(self, initial_data):
        ...
        self.trailer = TrailerLine(
            initial_data["trailer"][0], line_number=next(line_count)
        )

    def _is_valid(self, initial_data):
